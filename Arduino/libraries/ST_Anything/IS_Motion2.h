...
//    2015-11-14  Bryce Durham   Adapted contact sensor as motion sensor
//
//
//******************************************************************************************

#ifndef ST_IS_MOTION2_H
#define ST_IS_MOTION2_H

#include "InterruptSensor.h"

namespace st
{
	class IS_Motion2: public InterruptSensor
	{
		private:
		...
		public:
			...
			IS_Motion2(const __FlashStringHelper *name, byte pin, bool iState, bool internalPullup = false, long numReqCounts = 0); //(defaults to NOT using internal pullup resistors, and required counts = 0)
